  ...
  return (
    <>
      ...
      <LoanDescriptionContainer>
        <ImageContainer>
          <StyledImage src="/women.png" alt="Business Loan For Women" />
        </ImageContainer>
        <TextContainer>
          <Title>About Our Business Loans for Women</Title>
          <Text>
            Our business loans for women are designed to help female entrepreneurs grow and expand their businesses effortlessly. With quick approval processes and minimal documentation, you can get up to ₹30 lakhs in just 5 minutes.
          </Text>
          <Text>
          ...
          <Text id="about-business-loans-for-women">

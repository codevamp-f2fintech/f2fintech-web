...
const products = [
    {
        ...
        additionalInfo: 'Amidst the bustling city, where the cacophony of traffic blends with the chatter of street vendors and the distant hum of construction, a solitary figure stands at the intersection, contemplating the ',
    },
    {
        id: 2,
        name: 'BAJAJ',
    ...
    },
    {
        ...
        description: 'Loan Provider 4 offers flexible repayment options and requires minimal KYC for application.',
    },
    {
        id: 5,
        ...
        DocumentRequired: 'No',
        description: 'Loan Provider 5 has lower penalties for late payment and offers easy repayment options.',
    },
    {
        id: 6,
        ...
        DocumentRequired: 'No',
        description: 'Loan Provider 6 is known for its excellent customer service and offers various repayment options.',
    },
];
...
function LoanProviderComparisonPage() {
    ...
    return (
        <Container style={{backgroundSize: 'cover', backgroundPosition: 'center',
            background:
            "linear-gradient(to right, rgba(0, 235, 219, 0.5), rgba(189, 113, 236, 0.5))",
          borderRadius: "0% 100% 0% 100% / 0% 100% 0% 100%", padding: '40px' }}>
            <Box my={4}>
                ...
                {products.slice(0, 3).map((product, index) => (
                    <Grid item xs={12} md={4} key={product.id}>
                        ...
                        >
                            ...
                            />
                            <CardContent>
                                <Typography variant="h2" gutterBottom style={{ fontWeight: 'bold', color: 'blue' }}>
                                    {product.name}
                                </Typography>
                                <Box display="flex" alignItems="center">
                                    <AttachMoneyIcon sx={{ color: 'black' }} />
                                    <Typography variant="body2" gutterBottom style={{ fontWeight: 'bold', color: 'black' }} sx={{ marginLeft: 1 }}>
                                        ROI: {product.ROI}
                                    </Typography>
                                </Box>
                                <Box display="flex" alignItems="center">
                        ...
                        >
                            <CardContent>
                                ...
                                <Box display="flex" alignItems="center">
                                    <HighlightIcon sx={{ color: 'black' }} />
                                    <Typography variant="body2" sx={{ marginLeft: 1 }}>
                                        <strong>DocumentRequired:</strong> {product.DocumentRequired}
                                    </Typography>
                                </Box>
                                <Box mt={1}>
